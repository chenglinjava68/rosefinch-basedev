...
/**
 *
 * Title: Description: 派件/签收时效设置表（门店）实体
 *
 * @Company: 远成快运
 * @author qiaokangjun
 * @date 2016年11月7日 上午11:03:46
 *
 */
@Table(value = "T_SIGN_SITE_TIME")
public class SignSiteTimeEntity extends BizBaseEntity implements Serializable {

    private static final long serialVersionUID = -9192014769689130793L;
    // ID
    @Id
    @Column("ID")
    private Long id;
