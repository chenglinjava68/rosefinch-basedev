...
/**
 *
 * Title: Description:门店时效VO
 *
 * @Company: 远成快运
 * @author qiaokangjun
 * @date 2016年11月8日 上午11:48:27
 *
 */
public class SignSiteTimeVo implements Serializable {

    private static final long serialVersionUID = -5160580321010067173L;
    // ID
    private Long id;
    // 时效编号
    ...
    private List<SignSiteTimeReleVo> siteCodeList;
    ...
    public List<SignSiteTimeReleVo> getSiteCodeList() {
        return siteCodeList;
    }

    public void setSiteCodeList(List<SignSiteTimeReleVo> siteCodeList) {
